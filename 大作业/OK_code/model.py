...
class Generator(nn.Module):
    ...
    def __init__(self, d=128):
        ...
        self.deconv1 = nn.ConvTranspose2d(100, d*8, kernel_size=(4, 4), stride=(1, 1), padding=(0, 0))
        self.deconv1_bn = nn.BatchNorm2d(d*8)
        self.deconv2 = nn.ConvTranspose2d(d*8, d*4, kernel_size=(4, 4), stride=(2, 2), padding=(1, 1))
        self.deconv2_bn = nn.BatchNorm2d(d*4)
        self.deconv3 = nn.ConvTranspose2d(d*4, d*2, kernel_size=(4, 4), stride=(2, 2), padding=(1, 1))
        self.deconv3_bn = nn.BatchNorm2d(d*2)
        self.deconv4 = nn.ConvTranspose2d(d*2, d, kernel_size=(4, 4), stride=(2, 2), padding=(1, 1))
        self.deconv4_bn = nn.BatchNorm2d(d)
        self.deconv5 = nn.ConvTranspose2d(d, 3, kernel_size=(4, 4), stride=(2, 2), padding=(1, 1))
